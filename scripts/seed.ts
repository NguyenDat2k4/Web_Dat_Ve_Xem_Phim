...
const REAL_MOVIES = [
    { title: "Inside Out 2", trailer: "LEjhY29D29M", genre: "Animation", image: "https://images.unsplash.com/photo-1535223289827-42f1e9919769?q=80&w=800" },
    { title: "Deadpool & Wolverine", trailer: "73_1biulkYk", genre: "Action", image: "https://images.unsplash.com/photo-1608889175123-8ee362201f81?q=80&w=800" },
    ...
    { title: "Furiosa", trailer: "XJMuhwVlca4", genre: "Action", image: "https://images.unsplash.com/photo-1533929736458-ca588d08c8be?q=80&w=800" },
    ...
    { title: "A Complete Unknown", trailer: "m6EueP_4FfU", genre: "Biopic", image: "https://images.unsplash.com/photo-1493225255756-d9584f8606e9?q=80&w=800" },
    ...
    try {
        ...
        for (let i = 0; i < 20; i++) {
            ...
            const cinema = new Cinema({
                ...
                screens: faker.number.int({ min: 4, max: 8 })
            });
            cinemas.push(cinema);

            // Create rooms for each cinema
            for (let r = 1; r <= cinema.screens; r++) {
                roomsToCreate.push({
                    name: `Phòng ${r}`,
                    cinema: cinema._id,
                    type: faker.helpers.arrayElement(['2D', '3D', 'IMAX', '4DX']),
        ...
        console.log(`- Created ${createdCinemas.length} cinemas and ${createdRooms.length} rooms`);
        ...
        for (let i = 0; i < 150; i++) {
            ...
            const roomsInCinema = createdRooms.filter(r => r.cinema.toString() === cinema._id.toString());
            const room = faker.helpers.arrayElement(roomsInCinema);
        ...
        for (let i = 0; i < 100; i++) {
            ...
            bookings.push({
                ...
                paymentMethod: 'VNPAY',
                ticketCode: `CMX-${faker.string.alphanumeric(8).toUpperCase()}`,
                combos: [
