      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[700px] bg-card border-border overflow-y-auto max-h-[90vh]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <label htmlFor="movie-desc" className="text-sm font-medium">Mô tả phim</label>
              <textarea 
                id="movie-desc"
            ...
            <div className="flex gap-8">
                <label htmlFor="is-featured" className="flex items-center gap-2 cursor-pointer">
                    <input 
                        id="is-featured"
                        type="checkbox" 
                ...
                <label htmlFor="is-coming-soon" className="flex items-center gap-2 cursor-pointer">
                    <input 
                        id="is-coming-soon"
                        type="checkbox" 
